...
def recognize_face(f1, f2):
    image = face_recognition.load_image_file(f1)
    encoding = face_recognition.face_encodings(image)[0]
    retval = compare(encoding, f2)

    return retval
    
# print (recognize_face ("aryan1.png", "aryan2.jpeg"))


##
# image = face_recognition.load_image_file("aryan1.png")
# encoding = face_recognition.face_encodings(image)[0]
# ##print(str(encoding))
# print(compare(encoding, "aryan2.jpeg"))
